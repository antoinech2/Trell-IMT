...
def get_collaborators():
    ...
    if task_id:
        ...
        etiquette = [{"id": etiquette.id, "name" : etiquette.label, "description":etiquette.description, "color": etiquette.color} for etiquette in Task.query.filter_by(id=task_id).first().etiquettes]
